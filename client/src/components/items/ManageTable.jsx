    ...
    <section className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-50 via-slate-100 to-slate-200 py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {filteredProducts.length > 0 ? (
          <>
            {/* 1. MOBILE RESPONSIVE CARD VIEW (Visible on mobile, hidden on Desktop) */}
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-center gap-3">
                      <div className="relative flex h-14 w-14 shrink-0 items-center justify-center rounded-xl border border-slate-100 bg-slate-100 text-slate-400 overflow-hidden shadow-inner">
                        {product.image ? (
                          <Image
                            src={product.image}
                    ...
                    <span className="inline-flex items-center rounded-lg bg-slate-100 px-2 py-0.5 text-[10px] font-bold text-slate-600 uppercase tracking-wide">
                  ...
                  <div className="flex items-center justify-between border-t border-slate-100 pt-3">
                    ...
                    {/* Compact Button Actions Container */}
                    <div className="flex items-center gap-1.5">
                      <Link
                        href={`/items/${product._id}`}
                        className="p-2.5 rounded-xl border border-slate-200 bg-white text-slate-600 hover:text-slate-900 shadow-sm"
                        title="View"
                      >
                        <FaEye size={14} />
                      </Link>
                      <Link
                        ...
                        className="p-2.5 rounded-xl bg-amber-500 text-white hover:bg-amber-600 shadow-sm"
                        title="Edit"
                      >
                        <FaEdit size={14} />
                      </Link>
            ...
            {/* 2. DESKTOP TABLE VIEW (Hidden on Mobile, visible on md: up) */}
            <div className="hidden md:block overflow-hidden rounded-2xl border border-slate-200/80 bg-white/80 backdrop-blur-md shadow-[0_20px_50px_rgba(15,_23,_42,_0.04)]">
